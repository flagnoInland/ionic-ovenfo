...
import { BUIProcedimiento } from "./bui.builder.procedimiento";

export class BUIConstructor {
    
    private config : any;
    private procedimiento : BUIProcedimiento;
    private util : BUIBuilderUtil;

    constructor(coreData : any){
        this.config = coreData;
        this.procedimiento = new BUIProcedimiento(coreData);
